...
@section('page_header')
    ...
    <i class="fa fa-shopping-cart"></i> Edit Sale
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="customer" autofocus name="customer" value="{{ $sale->customer->customer_name }}"
                                                    class="form-control" placeholder="Search Customer..">
                                            <input type="text" id="customer_id" name="customer_id" value="{{ $sale->customer_id }}"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text" data-type="itemName" name="itemName[]"
                                                                       value="{{ $value->item->item_name }}" id="itemName_{{ $key+1 }}"
                                                            ...
                                                            <td style="display: none">
                                                                <input type="text" data-type="itemId"
                                                                       value="{{ $value->item_id }}" name="itemId[]"
                                                                       id="itemId_{{ $key+1 }}" class="form-control autocomplete_txt"
                                                                       autocomplete="off">
                                                            </td>

                                                            <td>
                                                                <input type="text" tabindex="-1" name="unit_prices[]"
                                                                       value="{{ $value->price }}" id="price_{{ $key+1 }}" readonly
                                                            ...
                                                            <td>
                                                                <input type="text" name="quantities[]"
                                                                       value="{{ $value->quantity }}" id="quantity_{{ $key+1 }}"
                                                                       class="form-control changesNo" autocomplete="off"
                                                                       onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                                       onpaste="return false;">
                                                            </td>
                                                            ...
                                                            <td>
                                                                <input type="text" readonly name="item_sub_total[]"
                                                                       value="{{ $value->sub_total }}" id="total_{{ $key+1 }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.00"
                                           class="form-control"
                                           name="sub_total" id="subTotal" value="{{ $sale->total_sub_total }}" readonly
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.00"
                                           class="form-control"
                                           name="total_payable" value="{{ $sale->total_payable }}" readonly
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.00" readonly tabindex="-1" class="form-control amountDue"
                                           name="amountDue" value="{{ $sale->total_payable - $sale->paid_amount}}" id="amountDue"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.00"
                                           class="form-control"
                                           name="amount_paid" value="{{ $sale->paid_amount }}"
